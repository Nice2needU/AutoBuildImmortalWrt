...
# CUSTOM_PACKAGES="$CUSTOM_PACKAGES adguardhome"
...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES qrencode"
...
#===========================以下imm仓库内的软件==============================↓
CUSTOM_PACKAGES="$CUSTOM_PACKAGES avahi-utils acme-acmesh-dnsapi luci-ssl-openssl kmod-sched kmod-tcp-bbr tcpdump bind-dig ss mtr-json hping3 arp-scan nmap-full bind-nslookup bind-host tc-full iftop vnstat2 luci-app-vnstat2 luci-i18n-vnstat2-zh-cn bmon ip-bridge iputils-arping htop procps-ng lsof strace pciutils usbutils"
